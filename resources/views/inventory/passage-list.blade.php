    ...
    <div class="col-12 mb-4">
        <div class="card border-light shadow-sm components-section">
            <div class="card-header border-bottom border-light">
                <h3 class="h5 mb-0">Road Management</h3>
            </div>
            <div class="card-body">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center ">
                    <a href="{{route('road.form')}}" class="btn btn-primary btn-sm mr-2">
                        <span class="fas fa-plus mr-2"></span>Add Road
                    </a>
                </div>
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0 rounded" id="tblListRoad">
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#tblListRoad').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('load.road') }}",
            columns: [{
                    data: 'code',
                    name: 'code',
                    className: "border-0"
