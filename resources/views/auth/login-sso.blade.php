            ...
            @csrf
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('ic_no') is-invalid @enderror" placeholder="991122023333" id="ic_no" value="{{ old('ic_no') }}" name="ic_no" required autocomplete="email" autofocus>
                    </div>
