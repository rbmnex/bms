        ...
        <div class="card border-light shadow-sm components-section">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center ">
                    <a href="{{route('user.form')}}" class="btn btn-primary btn-sm mr-2">
                        <span class="fas fa-plus mr-2"></span>Add User
                    </a>
                </div>
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0 rounded" id="tblListUser">
                        <thead class="thead-light">
                            <tr>
                                <!--<th class="border-0">#</th> -->
                                <th class="border-0">Name</th>
                                <th class="border-0">IC Number</th>
